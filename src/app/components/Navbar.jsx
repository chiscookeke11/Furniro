...
const Navbar = () => {
  ...
  const connetWallet =  async () => {
    let connection = await connect({webwalletUrl: "https://web.argent.xyz"})
  }
  ...
  return (
   <header className='font-poppins w-full flex items-center justify-between bg-white px-[5%] py-[2%] shadow-lg  ' >
     ...
     <button className='py-2 px-3 bg-blue-600 rounded-sm cursor-pointer ' onClick={connetWallet} >Connect Wallet</button>
