    ...
    return (
        <div className="w-full " >
            <label htmlFor={inputId} className=" w-full flex flex-col items-start gap-1 " >
                ...
                <input onChange={onChange}  type={type} placeholder={placeholder} id={inputId} value={value} name={name} className="w-full outline-none  border-[1px] border-[#9F9F9F] h-[50px] md:h-[75px] rounded-[10px] px-3 py-2 text-[#000000] font-normal text-sm md:text-base " required={required} />
            </label>
