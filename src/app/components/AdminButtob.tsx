  ...
  return (
    <div className="fixed right-5 bottom-7 transform scale-50 hover:scale-100 transition duration-200 ease-in-out">
      <Dialog open={open} onOpenChange={setOpen}>
        ...
        <DialogContent>
          <DialogHeader>
            <DialogTitle className="font-bold text-[30px] text-[#B88E2F] font-poppins">
              Admin functions
            </DialogTitle>
            <ul className="flex flex-col items-start gap-2 mt-2 " >
              <li
                onClick={() => handleRoute("/blog-upload-page")}
                className="text-base font-medium text-[#000000] font-poppins  hover:text-[#B88E2F] cursor-pointer"
              >
                Add Blog
              </li>
              <li
