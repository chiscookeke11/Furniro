...
<h3 className=" text-[#000000] text-base font-normal " >    {product.furnitureName}</h3>
<p className="text-[13px] font-[300px] text-[#000000]  "  > <span className=" text-base "  >1</span>  x <span className=" text-[#B88E2F] font-medium text-xs "  >Rs. 270, 000.000</span>     </p>
</div>
...
<CircleX size={20}  className=" hover:text-[red] text-[#9F9F9F]  "   />
    ...
    <div className=" w-full flex items-center justify-between  max-w-[280px] pl-[6%] mt-[25px] "  >
        ...
        <p className="text-[#B88E2F] font-semibold text-base " >Rs. 520,000.00</p>
    </div>
</ul>
